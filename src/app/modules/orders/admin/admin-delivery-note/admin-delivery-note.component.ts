...
@Component({
  selector: 'app-admin-delivery-note',
  templateUrl: './admin-delivery-note.component.html',
  styleUrls: ['./admin-delivery-note.component.scss'],
})
export class AdminDeliveryNoteComponent implements OnInit {
